...
Op-pattern translation table (source -> target):
  func.func @kernel(...)               -> @nki.jit def matmul_kernel_nki(lhsT, rhs)
  arith.constant 128/128/128                 -> TILE_M/N/K constants (snapped to 64/128)
...
Tile sizes:  TILE_M=128  TILE_N=128  TILE_K=128
