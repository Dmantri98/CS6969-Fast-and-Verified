module {
  func.func @matmul_relu_kernel(%arg0: memref<*xf32>, %arg1: memref<*xf32>, %arg2: memref<*xf32>, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32, %arg12: i32, %arg13: i32, %arg14: i32, %arg15: i32, %arg16: i32, %arg17: i32) {
    ...
    %2 = nki.psum_alloc : tensor<128x512xf32>
    %3 = arith.addi %arg4, %c511_i32 : i32
    %4 = arith.divsi %3, %c512_i32 : i32
    scf.for %arg18 = %c0_i32 to %1 step %c1_i32  : i32 {
      scf.for %arg19 = %c0_i32 to %4 step %c1_i32  : i32 {
        %5 = arith.muli %arg18, %c128_i32 : i32
        %6 = arith.muli %arg19, %c512_i32 : i32
        %7 = arith.addi %arg5, %c127_i32 : i32
        %8 = arith.divsi %7, %c128_i32 : i32
        %9 = scf.for %arg20 = %c0_i32 to %8 step %c1_i32 iter_args(%arg21 = %2) -> (tensor<128x512xf32>)  : i32 {
          ...
          %32 = nki.dma_copy %arg0[%24] strides[%19, %22] : memref<*xf32> to tensor<128x128xf32>
          %33 = nki.dma_copy %arg1[%31] strides[%26, %29] : memref<*xf32> to tensor<128x512xf32>
          %34 = nki.nc_matmul %32, %33, %arg21 : (tensor<128x128xf32>, tensor<128x512xf32>, tensor<128x512xf32>) -> tensor<128x512xf32>
          scf.yield %34 : tensor<128x512xf32>
        }
        ...
        nki.dma_store %9 into %arg2[%16] strides[%11, %14] {activation = "relu"} : tensor<128x512xf32> into memref<*xf32>
      }
    }
    return
  }
