    ...
    scf.for %arg18 = %c0_i32 to %1 step %c1_i32  : i32 {
      scf.for %arg19 = %c0_i32 to %4 step %c1_i32  : i32 {
        ...
        %9 = scf.for %arg20 = %c0_i32 to %8 step %c1_i32 iter_args(%arg21 = %2) -> (tensor<64x64xf32>)  : i32 {
          ...
          %33 = nki.dma_copy %arg1[%31] strides[%26, %29] : memref<*xf32> to tensor<64x64xf32>
          %34 = nki.nc_matmul %32, %33, %arg21 : (tensor<64x64xf32>, tensor<64x64xf32>, tensor<64x64xf32>) -> tensor<64x64xf32>
        ...
        nki.dma_store %9 into %arg2[%16] strides[%11, %14] {activation = "relu"} : tensor<64x64xf32> into memref<*xf32>
      }
    }
    return
  }
