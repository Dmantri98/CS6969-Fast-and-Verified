    ...
    scf.for %arg18 = %c0_i32 to %1 step %c1_i32  : i32 {
      scf.for %arg19 = %c0_i32 to %4 step %c1_i32  : i32 {
        ...
        %9 = scf.for %arg20 = %c0_i32 to %8 step %c1_i32 iter_args(%arg21 = %2) -> (tensor<256x128xf32>)  : i32 {
          ...
          %32 = nki.dma_copy %arg0[%24] strides[%19, %22] : memref<*xf32> to tensor<256x128xf32>
          %33 = nki.dma_copy %arg1[%31] strides[%26, %29] : memref<*xf32> to tensor<128x128xf32>
          %34 = nki.nc_matmul %32, %33, %arg21 : (tensor<256x128xf32>, tensor<128x128xf32>, tensor<256x128xf32>) -> tensor<256x128xf32>
          scf.yield %34 : tensor<256x128xf32>
        }
        ...
        nki.dma_store %9 into %arg2[%16] strides[%11, %14] : tensor<256x128xf32> into memref<*xf32>
      }
    }
    return
  }
